...
- **Full Format pane styling.** Header colours, accent colour, alternating row shading, font size, heatmap colours and more are all configurable, so the table matches your report theme.
